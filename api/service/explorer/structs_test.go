...
func TestGetTransaction(t *testing.T) {
	...
	block := types.NewBlock(blockfactory.NewTestHeader().With().Number(big.NewInt(314)).Header(), types.BlockTransactionsFromLegacy(txs), types.Receipts{&types.Receipt{}, &types.Receipt{}, &types.Receipt{}}, nil, nil, nil)
